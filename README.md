...
For a full list of available icons and their names, see the [package documentation](fontawesome7/doc/fontawesome7.pdf) or the [Font Awesome icon gallery](https://fontawesome.com/icons).
